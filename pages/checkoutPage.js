                ...
                <div class="md:pr-12">
                                  ...
                                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                    ...
                                    <div className="relative p-6 flex-auto">
                                      <p className="my-4 text-blueGray-500 text-lg font-semibold leading-relaxed">
                                        ...
                                        your host will be awaiting you on{" "}
                                        {range}. Hope you enjoy your vacay with
                                        Airbnb.
                                      </p>
                                    </div>
                  ...
                  <ul class="list-none mt-6">
                    ...
                    <p class="mt-3 pl-6 text-sm leading-relaxed text-blueGray-500">
                      Non-refundable: Cancel before check-in and get back only
                      the cleaning fee, if you've paid one. Learn more
                    </p>
